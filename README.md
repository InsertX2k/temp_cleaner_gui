...
You can find accurate and up-to-date instructions for building this program from source in the Wiki. [You should start from the first step here](https://github.com/InsertX2k/temp_cleaner_gui/wiki/Environment-%E2%80%90-Building-Temp_Cleaner-GUI-from-source)
