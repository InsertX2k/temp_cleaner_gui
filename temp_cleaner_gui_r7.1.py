...
class SettingsWindow(Toplevel):
    def __init__(self):
        ...
        self.lbl6_config.grid(column=0, row=8, sticky='w', pady=4)
        ...
        self.appearance_chooser_combo.grid(column=0, row=9, sticky='w')
        ...
        self.lbl7_config.grid(column=0, row=10, sticky='w', pady=4)
        ...
        self.language_chooser_combo.grid(column=0, row=11, sticky='w')
        ...
        self.lbl8_config.grid(column=0, row=12, sticky='w', pady=4)
        ...
        self.checkforupdatesautomatically.grid(column=0, row=13, sticky='w')
        ...
        self.lbl9_config.grid(column=0, row=14, sticky='w', pady=4)
        ...
        self.show_startuptips.grid(column=0, row=15, sticky='w')
        ...
        self.random_spacing.grid(column=0, row=16, sticky='w')
