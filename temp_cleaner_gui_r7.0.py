...
try:
    import tkthread
    tkthread.patch() # installing multithreading tkinter patch.
except Exception as errInstallingMultiThreadPatch:
    print(f"[ERROR]: An exception has occured causing this program to be unable to run\nan error has occured while trying to implement the multithreading patch for tkinter/tcl\nError details are:\n{errInstallingMultiThreadPatch}")
    raise SystemExit(299512) # error code for import error
            ...
            if self.selection82 == "1": # it is checked.
                ...
                if _chosen_cleaning_method == str(getCurrentLanguage().usb_adb): # the chosen method is via usb debugging.
                    ...
                    if adb_processor.needToShowInstructionsWindow() == True:
                        ...
                        tkthread.call(connection_window.ConnectPhoneToPCWindow)
                        # _window.mainloop()
