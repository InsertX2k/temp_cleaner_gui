...
class MainWindowLightMode(Tk):
    def __init__(self):
        ...
        self.exec_btn = ttk.Button(self.show_frame, text=self.begin_cleaning_btn_text, command=multiprocessing_execute_btn_function, cursor='hand2')
...
"""
            about_window_title = "About 'The Temp_Cleaner GUI Project (v4.7)'"
        elif str(GetConfig['ProgConfig']['languagesetting']) == 'ar':
...
"""
            about_window_title = "حول 'The Temp_Cleaner GUI Project (v4.7)'"
        else:
            about_window_txt = """The Temp_Cleaner GUI Project by Insertx2k Dev\n
Version 4.7
Written by Insertx2k Dev (Mr.X)
