...
class en:
    ...
    winexp_thumbcache_text = "Windows Explorer Cached Thumbnails"
    user_recents_text = "Your Recent Documents List"
    local_low_temp_text = "LocalLow User Temp"
    webbrowsers_text = "Web Browsers"
    gchrome_webcache_text = "Google Chrome Web Cache (+ GPUCache, Code Cache)"
    gchrome_cookies_text = "Google Chrome Cookies"
    gchrome_extensions_cookies_text = "Google Chrome Extensions Cookies"
    steam_htmlcache_text = "Steam Webclient HTML Cache"
    discord_webcache_text = "Discord app Caches"
    chromium_based_edge_webcache_text = "Chromium-based Microsoft Edge Web Cache (+ GPUCache, Code cache)"
    chromium_based_edge_cookies_text = "Chromium-based Microsoft Edge Cookies"
    firefox_webcached_data_text = "Mozilla Firefox Web Cache (+ cache2, jumpListCache, and Shader Cache)"
    mozilla_firefox_cookie_data_text = "Mozilla Firefox Cookies"
    discord_squirrel_temp = "Discord app Squirrel Temp"
    iecookies_text = "Internet Explorer Cookies"
    adds_ietemp_text = "Internet Explorer Additional Temp"
    iedownloadhistory_text = "Internet Explorer Download History"
    photo_editors_text = "Photo Editors"
    gimp_tmp_text = "GIMP's temp"
    ...
    winupdate_downloadedfiles_text = "Windows Update Downloaded Files"
    win10plus_cleaners_text = "Windows 10 or newer only"
    win10plus_oscache_text = "Windows 10/11 OS Cache"
    actioncenter_cache_text = "Action Center Cache"
    modern_apps_cache_text = "Modern Apps Cache"
    msedge_msstore_webcache_text = "Microsoft Store-based MS Edge Web Cache"
    ...
    python_cleaners_text = "Python by Python Software Foundation"
    ...
    empty_running_workingsets_rammap_text = "Use RAMMap by Sysinternals to Free up RAM Space."
    video_editing_software_text = "Video Editing Software"
    vegaspro17_temp_text = "Sony Vegas Pro 17 Temp and Log files"
    vegaspro17_errorlogs_text = "Sony Vegas Pro 17 ERROR Logs"
    threed_moduling_software_text = "3D Moduling Software"
    mcneel_rhinoceros_3d_temp_text = "McNeel Rhinoceros Temp"
    ...
    malwarebytes_adware_cleaner_text = "Malwarebytes Adware Cleaner log files and others"
    ...
    balenaitcher_webcache_files_text = "BalenaItcher Web Cache"
    ...
    huawei_hisuite_dnddata_text = "Huawei HiSuite Drag 'n' Drop Files"
    vscode_text = "Microsoft Visual Studio Code"
    vscode_webcache_text = "VS Code Web cache"
    ...
    alldone_text = "Are you done, mate?"
    alldone_chkbox_text = "Do you want me to automatically close myself when I'm done with cleaning up your PC?"
    ...
    restart_winupdate_window_content_text = "After you delete all downloaded files by Windows Update, you must restart it's service to ensure proper functionality after cleaning, Do you want me to do that for you now?"
    ...
    not_restarting_winupdate_service_warning_text = "Expect your device to have problems with Windows Update service if you didn't restart it as soon as possible then."
    clean_ms_store_based_edge_cache_window_title = "Clean Store-based MS Edge Cache"
    clean_ms_store_based_edge_cache_dialog_one_content = "Cleaning Store-based MS Edge cached data can not be done automatically, which means you are supposed to do that manually, which will make this tool open an explorer (Windows Explorer) window for you showing you the folder where you are supposed to clean MS-Store-Based EDGE Webcache data\nPlease keep in mind that you shouldn't leave the directory opened to you by this tool\nSo do you wish to processed?"
    clean_ms_store_based_edge_cache_dialog_two_content = "Opening the directory for you\nDon't forget to look for the folder Microsoft.MicrosoftEdge_[a random number], and go inside the AC folder inside of it, you will then be able to see all MS Store-based edge webcached data."
    done_text = "Done!"
    operation_interrupted_by_user = "Operation Interrupted by user!"
    erase_rammap_title = "Empty Windows Workingsets"
    erase_rammap_content = "Would you really like to run RAMMap by Sysinternals to empty RAM Workingsets?"
    ...
    iconcache_dialog_text = "Cleaning IconCache.db file can not be done automatically, which means the user is premitted to do that manually, all what you have to do is just deleting the file iconcache.db in the directory we will open to you\nDo you wish to processed?"
    clear_icon_cache_dialog_text = "Clean icon cache"
    nocustom_path_foradwcleaner_text = "You didn't specify a custom working location for the AdwareCleaner Cleaner, Continuing using the default path."
...
"""
    ...
    about_window_title = "About 'The Temp_Cleaner GUI Project (v5.1)'"
    ...
    cant_read_config_frominside_file_msgbox_content = "Unable to read the configuration file from your computer, please make sure to give this program a permission to read files in your hard disk if blocked by your antivirus software and try again, The settings window will close."
    ...
    prog_title_no_username = "Welcome to Temp_Cleaner GUI v5.1!"
    prog_title_1 = "Welcome "
    prog_title_2 = " to Temp_Cleaner GUI v5.1!"
    ...
    appearance_mode_settings_hint = "Choose the appearance mode (Light or Dark): "
...
class ar:
    ...
    windrv_recycle_bin_text = "سلة مهملات قرص النظام"
    dxdcache_text = "(نطام ويندوز 10 او احدث فقط) D3D Shaderذاكرة التخزين المؤقت ل"
    sys_user_specific_text = "ملفات خاصة بالنظام او المستخدم غير ضرورية"
    prefw_text = "التجهيز المسبق (PrefetchW)"
    clipboard_text = "الحافظة"
    windir_temp_text = "ملفات الويندوز المؤقتة"
    user_temp_text = "ملفات المستخدم المؤقتة"
    defuser_temp_text = "ملفات المستخدم الإفتراضي المؤقتة"
    iecache_text = "ملفات مستكشف الإنترنت المؤقتة"
    winexp_thumbcache_text = "الصور المصغرة الخاصة بمستكشف الويندوز" 
    user_recents_text = "لائحة اخر ملفات تم فتحها"
    local_low_temp_text = "المؤقتة LocalLow ملفات المستخدم "
    webbrowsers_text = "المتصفحات"
    gchrome_webcache_text = "(GPUCache, Code Cache +) ملفات مواقع الويب المؤقتة الخاصة بمتصفح جوجل كروم "
    gchrome_cookies_text = "الكعكات الخاصة بمتصفح جوجل كروم"
    gchrome_extensions_cookies_text = "كعكات المكونات الإضافية الخاصة بمتصفح جوجل كروم"
    steam_htmlcache_text = "Steamملفات الإنترنت المؤقتة الخاصة ب"
    discord_webcache_text = "ملفات الديسكورد المؤقتة"
    chromium_based_edge_webcache_text = "(GPUCache, Code cache +) ملفات متصفح ميكروسوفت ادجي الجديد المؤقتة "
    chromium_based_edge_cookies_text = "كعكات ميكروسوفت ادجي الجديد"
    firefox_webcached_data_text = "(cache2, jumpListCache, and Shader Cache +)ملفات متصفح موزيلا فايرفوكس المؤقتة "
    mozilla_firefox_cookie_data_text = "كعكات موزيلا فايرفوكس"
    discord_squirrel_temp = "المؤقتة الخاصة بالديسكورد Squirrel ملفات "
    iecookies_text = "كعكات مستكشف الإنترنت"
    adds_ietemp_text = "ملفات مستكشف الإنترنت المؤقتة الإضافية"
    iedownloadhistory_text = "سجل تنزيلات مستكشف الإنترنت"
    photo_editors_text = "برامج تعديل الصور"
    gimp_tmp_text = "الملفات المؤقتة الخاصة ببرنامج جيمب"
    gimp_recent_docs_list_text = "قائمة اخر ملفات الخاصة ببرنامج جيمب"
    ps2020_webcache_text = "الملفات المؤقتة لمتصفح الويب الموجود في فوتوشوب 2020"
    winupdate_text = "برنامج تحديث الويندوز"
    winupdate_downloadedfiles_text = "الملفات المحملة من برنامج تحديث الويندوز"
    win10plus_cleaners_text = "خاص بويندوز 10 او احدث فقط"
    win10plus_oscache_text = "الملفات المؤقتة الخاصة بنظامي ويندوز 10/11"
    actioncenter_cache_text = "ملفات مركز الإشعارات المؤقتة"
    modern_apps_cache_text = "الملفات المؤقتة الخاصة بالتطبيقات الحديثة"
    msedge_msstore_webcache_text = "الملفات المؤقتة الخاصة بمتصفح ادجي النسخة القديمة"
    thumbcachetodelete_text = "(thumbcachetodelete) الملفات المؤقتة الإضافية الخاصة بالصور المصغرة لمستكشف الويندوز "
    cryptneturl_text = "المؤقتة Cryptnet URL ملفات "
    connecteddevicesplatform_cache_text = "المؤقتة ConnectedDevicesPlatform ملفات "
    elevateddiagnostics_text = "(ملفات التشخيصات العليا (غير مستحسن"
    identitynexusintegration_text = "IdentityNexusIntegration محتويات المجلد "
    servicehub_identity_file_text = "(غير مستحسن) ServiceHub ملف الهوية الشخصية لبرنامج "
    games_text = "الألعاب"
    roblox_textures_text = "قوام لعبة روبلوكس المحملة"
    roblox_verbosed_logs_text = "سجلات لعبة روبلوكس"
    axolot_games_scrapmechanic_workshop_cache_text = "Axolot Games Scrap Mechanic الملفات المؤقتة الخاصة بعناصر"
    minecraft_webcache_text = "ملفات الإنترنت المؤقتة الخاصة بماينكرافت"
    python_cleaners_text = "Python Software Foundation بايثون من"
    pypip_text = "المؤقتة pip ملفات بايثون "
    pyinstaller_bin_cache_text = "المؤقتة bin Pyinstaller ملفات "
    jedi_python_cache_text = "Jedi Pythonالملفات المؤقتة الخاصة ب"
    ram_text = "(RAM) ذاكرة الوصول العشوائي"
    empty_running_workingsets_rammap_text = "لتفريغ مساحة في ذاكرة الوصول العشوائي Sysinternals من RAMMap إستخدام برنامج "
    video_editing_software_text = "(برامج تعديل الفيديوهات (المونتاج"
    vegaspro17_temp_text = "Sony Vegas Pro 17 الملفات المؤقتة وملفات السجل الخاصة ب"
    vegaspro17_errorlogs_text = "Sony Vegas Pro 17 تقارير الاخطاء الخاصة ببرنامج"
    threed_moduling_software_text = "برامج تعديل الصور ثلاثية الابعاد"
    mcneel_rhinoceros_3d_temp_text = "المؤقتة McNeel Rhinoceros ملفات برنامج  "
    adds_software_text = "البرامج الاخري"
    iconcachefile_text = "الملفات المؤقتة الخاصة بالرموز"
    microvert_memu_logs_memdump_text = "Microvirt MEmu ملفات اخطاء الذاكرة وسجلات برنامج"
    malwarebytes_adware_cleaner_text = "Malwarebytes Adware Cleaner ملفات سجل برنامج "
    perflogs_sysdrive_text = "سجلات الاداء"
    android_cached_data_text = "ملفات نظام اندرويد المؤقتة"
    vmware_downloads = "VMware الملفات المحملة بواسطة برامج"
    balenaitcher_webcache_files_text = "BalenaItcher الملفات المؤقتة الخاصة ببرنامج"
    lowlevelformattool_agreement_file_text = "LowLevelFormatTool (LLFT) ملف قبول إتفاقية تراخيص برنامج"
    winxpe_creator_downloadsdir_text = "(تأكد من تعيين مسار البرنامج في الضبط) WinXPE Creator تنزيلات برنامج"
    huawei_hisuite_logdata_text = "Huawei HiSuite ملفات سجلات برنامج"
    huawei_hisuite_dnddata_text = "Huawei HiSuite ملفات السحب والإفلات المؤقتة الخاصة ببرنامج"
    vscode_text = "Microsoft Visual Studio Code"
    vscode_webcache_text = "VS Code الملفات المؤقتة الخاصة ب"
    vscode_cookies_text = "VS Code كعكات"
    vscode_cached_extensions_text = "VS Code ملفات المكونات الإضافية المؤقتة"
    javadeployment_text = "ملفات توظيف الجافا المؤقتة"
    alldone_text = "هل انتهيت يا رفيق?"
    alldone_chkbox_text = "هل تريد الإغلاق تلقائيا عقب الإنتهاء من التنظيف؟"
    settings_text = "الضبط"
    execute_text = "ابدأ تنظيف!"
    about_text = "حول البرنامج ونصائح"
    executing_text = "جاري التنظيف..."
    restart_winupdate_window_title_text = "إعادة تشغيل خدمة تحديث ويندوز"
    restart_winupdate_window_content_text = "بعد مسح جميع الملفات  التي تم تنزيلها بواسطة برنامج تحديث ويندوز يجب عليك إعادة تشغيل الخدمة الخاصة به ، هل تريد مني القيام بذلك من اجلك؟"
    ...
    not_restarting_winupdate_service_warning_text = "توقع ان تواجه مشاكل خلال إستخدامك لبرنامج تحديث الويندوز"
    ...
    erase_rammap_title = "تفريغ مجموعات العمل الخاصة بنظام ويندوز"
    ...
    an_error_has_occured_text = "لقد حدث خطأ بسيط"
...
"""
    ...
    about_window_title = "حول 'The Temp_Cleaner GUI Project (v5.1)'"
    ...
    prog_title_1 = " مرحبا"
    prog_title_2 = " Temp_Cleaner GUI v5.1 في "
    ...
    appearance_mode_settings_hint = ":(Dark:مظلم ، Light:اختار المظهر (فاتح "
