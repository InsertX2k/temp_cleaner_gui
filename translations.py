...
class en:
    ...
    execute_text = "Clean Now!"
    about_text = "About"
    executing_text = "Cleaning..."
...
"""
    ...
    about_window_title = "About 'The Temp_Cleaner GUI Project (v4.8)'"
    ...
    prog_title_no_username = "Welcome to Temp_Cleaner GUI v4.8!"
    prog_title_1 = "Welcome "
    prog_title_2 = " to Temp_Cleaner GUI v4.8!"
...
class ar:
    ...
    alldone_chkbox_text = "هل تريدني ان اغلق نفسي تلقائيا عقب إنتهائي من تنظيف جهازك؟"
    settings_text = "الضبط"
...
"""
    ...
    about_window_title = "حول 'The Temp_Cleaner GUI Project (v4.8)'"
    ...
    prog_title_1 = " مرحبا"
    prog_title_2 = " Temp_Cleaner GUI v4.8 في "
