...
""")
        ...
        #65 for wer cleaner
        #66 for delivery optimization cleaning
        #67 for windows logs cleaning
        ...
        self.windows_logs_cleanup = CTkCheckBox(self.lblframe12, text=getCurrentLanguage().windows_log_files, variable=self.var67, onvalue="1", offvalue="0", command=None)
        ...
        self.about_window_btn.place(x=10, y=2300, relwidth=0.3, relheight=0.035)
        ...
        self.exec_btn.place(x=400 ,y=2300, relwidth=0.3, relheight=0.035)
        ...
        self.config_page_btn.place(x=790 ,y=2300, relwidth=0.3, relheight=0.035)
        ...
        # ----------------------------
        if int(self.winfo_screenwidth()) <= 1024 and int(self.winfo_screenheight()) <= 768:
            self.about_window_btn.place(x=10, y=2300, relwidth=0.29, relheight=0.035)
            self.exec_btn.place(x=260 ,y=2300, relwidth=0.29, relheight=0.035)
            self.config_page_btn.place(x=510 ,y=2300, relwidth=0.29, relheight=0.035)
