...
root.configure(background=atk.DEFAULT_COLOR)

root.title("The Temp_Cleaner GUI Project (v3.1)")
...
def show_about_window():
    messagebox.showinfo("About The Temp_Cleaner GUI Project (v3.1)","""The Temp_Cleaner GUI Project by Insertx2k Dev\n
Version 3.1
Update 12
Written by Insertx2k Dev (Mr.X)
Support Twitter : @insertplayztw
\n
In this update of The Temp_Cleaner GUI Project, You will no longer see a seperate console output window, we've moved it in this window!
...
def StartConfigurationWindow():
    ...
    rammappath_input_browsebtn = atk.Button3d(ConfigRoot, text="...", command=BrowseOne)
    ...
    adwcleanerwpath_input_browsebtn = atk.Button3d(ConfigRoot, text="...", command=BrowseTwo)
    ...
    winxpeapppath_input_browsebtn = atk.Button3d(ConfigRoot, text="...", command=BrowseThree)
    ...
    cdpccpath_input_browsebtn = atk.Button3d(ConfigRoot, text="...", command=BrowseFour)
...
lblframe1 = ttk.Labelframe(show_frame, text="DirectX Shader Cache Cleanup (Win 10 Only)")
# ---------------------------
...
clr_windowsupdate_downloaded_updates_btn.grid(column=0, row=34, sticky='w')


lblframe5 = ttk.Labelframe(show_frame, text="Windows 10 only Cleaners")
# ---------------------------
clr_win10os_cached_data_btn = ttk.Checkbutton(lblframe5, text="Clean Windows 10 Operating System Cached Data", variable=var16, onvalue="1", offvalue="0", command=None)
clr_win10os_cached_data_btn.grid(column=0, row=35, sticky='w')
clr_win10_action_center_cached_data_btn = ttk.Checkbutton(lblframe5, text="Clean Windows 10 Action Center/Notifications Center Cached data", variable=var20, onvalue="1", offvalue="0", command=None)
clr_win10_action_center_cached_data_btn.grid(column=0, row=36, sticky='w')
clr_winappux_cached_data_btn = ttk.Checkbutton(lblframe5, text="Clean Windows 10 Modern Applications Cached data", variable=var21, onvalue="1", offvalue="0", command=None)
clr_winappux_cached_data_btn.grid(column=0, row=37, sticky='w')
clr_msstore_based_edge_webcached_data_btn = ttk.Checkbutton(lblframe5, text="Clean Microsoft Store Based Edge Web cached data", variable=var22, onvalue="1", offvalue="0", command=None)
clr_msstore_based_edge_webcached_data_btn.grid(column=0, row=38, sticky='w')
clr_winexplorer_thumbcache_to_delete_files_btn = ttk.Checkbutton(lblframe5, text="Clean Additional Windows Explorer Thumbnails Cached Data (thumbcachetodelete)", variable=var23, onvalue="1", offvalue="0", command=None)
clr_winexplorer_thumbcache_to_delete_files_btn.grid(column=0, row=39, sticky='w')
clr_cryptnet_urlcache_data_btn = ttk.Checkbutton(lblframe5, text="Clean Windows 10 Cryptnet URL Cached data", variable=var30, onvalue="1", offvalue="0", command=None)
clr_cryptnet_urlcache_data_btn.grid(column=0, row=40, sticky='w')
clr_connecteddevicesplatform_win10_cached_data_btn = ttk.Checkbutton(lblframe5, text="Clean Windows 10 ConnectedDevicesPlatform Cached Data (Requires you to set it's path in Settings)", variable=var34, onvalue="1", offvalue="0", command=None)
clr_connecteddevicesplatform_win10_cached_data_btn.grid(column=0, row=41, sticky='w')
clr_elevated_diagnostics_data_btn = ttk.Checkbutton(lblframe5, text="Clean Elevated Diagnostics Data folder (Only for Windows 10)", variable=var42, onvalue="1", offvalue="0", command=None)
clr_elevated_diagnostics_data_btn.grid(column=0, row=42, sticky='w')
clr_identitynexus_integration_folder_btn = ttk.Checkbutton(lblframe5, text="Clean IdentityNexusIntegration Folder contents (Only for Windows 10)", variable=var49, onvalue="1", offvalue="0", command=None)
clr_identitynexus_integration_folder_btn.grid(column=0, row=43, sticky='w')
clr_servicehub_identity_file_btn = ttk.Checkbutton(lblframe5, text="Clean ServiceHub Identity file (that salt file)", variable=var56, onvalue="1", offvalue="0", command=None)
clr_servicehub_identity_file_btn.grid(column=0, row=44, sticky='w')
# ---------------------------
lblframe5.grid(column=0, row=34, sticky='w')


lblframe6 = ttk.Labelframe(show_frame, text="Games Cleaner")
# ---------------------------
clr_roblox_game_downloads_btn = ttk.Checkbutton(lblframe6, text="Clean ROBLOX Game Downloaded Textures/Data", variable=var26, onvalue="1", offvalue="0", command=None)
clr_roblox_game_downloads_btn.grid(column=0, row=46, sticky='w')
clr_roblox_game_log_files_btn = ttk.Checkbutton(lblframe6, text="Clean ROBLOX Game Verbosed Log files", variable=var51, onvalue="1", offvalue="0", command=None)
clr_roblox_game_log_files_btn.grid(column=0, row=47, sticky='w')
clr_scrapmechanic_axolot_games_workshop_items_cached_data_btn = ttk.Checkbutton(lblframe6, text="Clean Axolot Games Scrap Mechanic Workshop Items Cached data", variable=var50, onvalue="1", offvalue="0", command=None)
clr_scrapmechanic_axolot_games_workshop_items_cached_data_btn.grid(column=0, row=48, sticky='w')
clr_minecraft_webcached_data_btn = ttk.Checkbutton(lblframe6, text="Clean Minecraft Webcached data", variable=var58, onvalue="1", offvalue="0", command=None)
clr_minecraft_webcached_data_btn.grid(column=0, row=49, sticky='w')
# ---------------------------
lblframe6.grid(column=0, row=45, sticky='w')


lblframe7 = ttk.Labelframe(show_frame, text="Python Cleaners")
# ---------------------------
clr_python_pip_cached_data_btn = ttk.Checkbutton(lblframe7, text="Clean Python PIP Cached Data", variable=var31, onvalue="1", offvalue="0", command=None)
clr_python_pip_cached_data_btn.grid(column=0, row=51, sticky='w')
clr_pyinstaller_temporary_data_btn = ttk.Checkbutton(lblframe7, text="Clean Pyinstaller Bin Cached Data", variable=var45, onvalue="1", offvalue="0", command=None)
clr_pyinstaller_temporary_data_btn.grid(column=0, row=52, sticky='w')
clr_jedipython_additionals_btn = ttk.Checkbutton(lblframe7, text="Clean Jedi Python Additional Temporary Data", variable=var46, onvalue="1", offvalue="0", command=None)
clr_jedipython_additionals_btn.grid(column=0, row=53, sticky='w')
# ---------------------------
lblframe7.grid(column=0, row=50, sticky='w')


lblframe8 = ttk.Labelframe(show_frame, text="RAM Cleaners")
# ---------------------------
empty_winworkingsets_rammap_btn = ttk.Checkbutton(lblframe8, text="Empty Running Software Workingsets using RAMMap", variable=var32, onvalue="1", offvalue="0", command=None)
empty_winworkingsets_rammap_btn.grid(column=0, row=55, sticky='w')
# ---------------------------
lblframe8.grid(column=0, row=54, sticky='w')


lblframe9 = ttk.Labelframe(show_frame, text="Video Editing Software Cleaners")
# ---------------------------
clr_sony_vegas_pro_temp_and_logs_data_btn = ttk.Checkbutton(lblframe9, text="Clean Sony VEGAS Pro 17 Temporary data and log files", variable=var28, onvalue="1", offvalue="0", command=None)
clr_sony_vegas_pro_temp_and_logs_data_btn.grid(column=0, row=57, sticky='w')
clr_sony_vegas_pro_error_reports_data_btn = ttk.Checkbutton(lblframe9, text="Clean Sony VEGAS Pro ERROR Reports files", variable=var61, onvalue="1", offvalue="0", command=None)
clr_sony_vegas_pro_error_reports_data_btn.grid(column=0, row=58, sticky='w')
# ---------------------------
lblframe9.grid(column=0, row=56, sticky='w')



lblframe10 = ttk.Labelframe(show_frame, text="3D Moduling Software Cleaners")
# ---------------------------
clr_mcneel_rhinoceros_3d_moduling_soft_cached_data_btn = ttk.Checkbutton(lblframe10, text="Clean McNeel Rhinoceros 3D Moduling Software Temporary Data", variable=var29, onvalue="1", offvalue="0", command=None)
clr_mcneel_rhinoceros_3d_moduling_soft_cached_data_btn.grid(column=0, row=60, sticky='w')
# ---------------------------
lblframe10.grid(column=0, row=59, sticky='w')


lblframe11 = ttk.Labelframe(show_frame, text="Additional Software Cleaners")
# ---------------------------
clr_iconcache_db_file_in_localappdata_dir_btn = ttk.Checkbutton(lblframe11, text="Clean Icon Cache file in Local app data folder", variable=var35, onvalue="1", offvalue="0", command=None)
clr_iconcache_db_file_in_localappdata_dir_btn.grid(column=0, row=62, sticky='w')
clr_microvirt_memu_log_data_memdump_files_btn = ttk.Checkbutton(lblframe11, text="Clean Microvirt MEmu Logs and Memory Dump Files", variable=var36, onvalue="1", offvalue="0", command=None)
clr_microvirt_memu_log_data_memdump_files_btn.grid(column=0, row=63, sticky='w')
clr_adwcleaner_log_files_btn = ttk.Checkbutton(lblframe11, text="Clean Malwarebytes Adware Cleaner Log data and its files", variable=var37, onvalue="1", offvalue="0", command=None)
clr_adwcleaner_log_files_btn.grid(column=0, row=64, sticky='w')
clr_perflogs_in_systemdrive_btn = ttk.Checkbutton(lblframe11, text="Clean the folder Perflogs in Systemdrive volume", variable=var38, onvalue="1", offvalue="0", command=None)
clr_perflogs_in_systemdrive_btn.grid(column=0, row=65, sticky='w')
clr_dotcache_folder_in_userprofile_path_btn = ttk.Checkbutton(lblframe11, text="Clean Android Cached data in your computer", variable=var39, onvalue="1", offvalue="0", command=None)
clr_dotcache_folder_in_userprofile_path_btn.grid(column=0, row=66, sticky='w')
clr_vmware_downloads_folder_btn = ttk.Checkbutton(lblframe11, text="Clean VMware Downloads (All files downloaded by all VMware Software)", variable=var43, onvalue="1", offvalue="0", command=None)
clr_vmware_downloads_folder_btn.grid(column=0, row=67, sticky='w')
clr_balena_itcher_webcached_data_btn = ttk.Checkbutton(lblframe11, text="Clean BalenaItcher webcached data (Incl. GPUCache, Code Cache, Local Storage, Session Storage)", variable=var44, onvalue="1", offvalue="0", command=None)
clr_balena_itcher_webcached_data_btn.grid(column=0, row=68, sticky='w')
clr_lowlevelformattool_licenseagreement_confirmationfile_btn = ttk.Checkbutton(lblframe11, text="Clean LowLevelFormatTool (LLFT) License Agreement Confirmation File", variable=var48, onvalue="1", offvalue="0", command=None)
clr_lowlevelformattool_licenseagreement_confirmationfile_btn.grid(column=0, row=69, sticky='w')
clr_winxpe_app_downloads_folder_btn = ttk.Checkbutton(lblframe11, text="Clean WinXPE Creator Downloads Diretory (Requires you to set it's path on Settings)", variable=var55, onvalue="1", offvalue="0", command=None)
clr_winxpe_app_downloads_folder_btn.grid(column=0, row=70, sticky='w')
clr_huawei_hisuite_log_data_btn = ttk.Checkbutton(lblframe11, text="Clean Huawei HiSuite Log data", variable=var57, onvalue="1", offvalue="0", command=None)
clr_huawei_hisuite_log_data_btn.grid(column=0, row=71, sticky='w')
clr_huawei_hisuite_dnd_temp_btn = ttk.Checkbutton(lblframe11, text="Clean Huawei HiSuite Drag 'n' Drop Temporary Data", variable=var63, onvalue="1", offvalue="0", command=None)
clr_huawei_hisuite_dnd_temp_btn.grid(column=0, row=72, sticky='w')
# ---------------------------
lblframe11.grid(column=0, row=61, sticky='w')



lblframe12 = ttk.Labelframe(show_frame, text="Microsoft Visual Studio Code Cleaners")
# ---------------------------
clr_vscode_webcached_data_btn = ttk.Checkbutton(lblframe12, text="Clean Microsoft Visual Studio Code Webcached data (Incl. GPUCache, Code Cache, CachedData, Cache paths)", variable=var52, onvalue="1", offvalue="0", command=None)
clr_vscode_webcached_data_btn.grid(column=0, row=74, sticky='w')
clr_vscode_cookie_data_btn = ttk.Checkbutton(lblframe12, text="Clean Microsoft Visual Studio Code Cookie data (Incl. Cookies-journal)", variable=var53, onvalue="1", offvalue="0", command=None)
clr_vscode_cookie_data_btn.grid(column=0, row=75, sticky='w')
clr_vscode_cached_extensions_data_btn = ttk.Checkbutton(lblframe12, text="Clean Microsoft Visual Studio Code Cached Extensions Data (Incl. VSIXs)", variable=var54, onvalue="1", offvalue="0", command=None)
clr_vscode_cached_extensions_data_btn.grid(column=0, row=76, sticky='w')
# ---------------------------
lblframe12.grid(column=0, row=73, sticky='w')


lblframe13 = ttk.Labelframe(show_frame, text="Java Deployment Cache Cleaner")
# ---------------------------
clr_java_deployment_cached_data_btn = ttk.Checkbutton(lblframe13, text="Clean Java Deployment Cached Data", variable=var62, onvalue="1", offvalue="0", command=None)
clr_java_deployment_cached_data_btn.grid(column=0, row=78, sticky='w')
# ---------------------------
lblframe13.grid(column=0, row=77, sticky='w')


lblframe14 = ttk.Labelframe(show_frame, text="All done?")
# ---------------------------
destroy_activity_after_done_btn = ttk.Checkbutton(lblframe14, text="Do you want to close this program when it's done with cleaning up temp?", variable=var64, onvalue="1", offvalue="0", command=None, cursor='hand2')
destroy_activity_after_done_btn.grid(column=0, row=80, sticky='w')
# ---------------------------
lblframe14.grid(column=0, row=79, sticky='w')


# Defining the about button.
about_window_btn = atk.Button3d(show_frame, text="About", command=show_about_window, cursor='hand2')
about_window_btn.place(x=10, y=2000, relwidth=0.3, relheight=0.039)
# Defining the execute button.
exec_btn = atk.Button3d(show_frame, text="Execute", command=execute_theprogram, cursor='hand2')
exec_btn.place(x=400 ,y=2000, relwidth=0.3, relheight=0.039)

# declaring a space.
space = Label(show_frame, text="", font=("Arial Bold", 50))
space.grid(column=0, row=81, sticky='w')

# Defining the go to configuration page button.
config_page_btn = atk.Button3d(show_frame, text="Settings", command=StartConfigurationWindow, cursor='hand2')
config_page_btn.place(x=790 ,y=2000, relwidth=0.3, relheight=0.039)


# another spacing
another_space = Label(show_frame, text="", font=("Arial Bold", 30))
another_space.grid(column=0, row=82, sticky='w')
...
def clr_console(keybinding_arg):
    ...
    output_show.insert(END, "The Temp_Cleaner GUI Project\nDebugging Console\n\n# The console output will appear here as soon as any process begin.")
    output_show.insert(END, "\n")
    output_show.configure(state='disabled')


lblframe15 = ttk.Labelframe(show_frame, text="Console Output")
# ------------------------
# Creating a scrolledtext widget.
output_show = scrolledtext.ScrolledText(lblframe15, cursor='arrow', background='#222222', foreground='white', selectbackground='cyan', selectforeground='black' ,state='disabled', font=("Arial", 14), width=106)
output_show.pack(fill=BOTH, expand=1)
# disabling the state of the output_show widget to prevent the GUI from glitching
output_show.configure(state='disabled')
# ------------------------
lblframe15.grid(column=0, row=83, sticky='w')
